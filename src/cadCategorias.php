        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="cadCategorias.html"><i class="far fa-user-circle"></i><span>Cadastro categorias</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="situação"><strong>Situação</strong><br></label><select class="form-select" id="situation" required="" name="situação">
