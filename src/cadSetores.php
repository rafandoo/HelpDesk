...
<?php
    ...
    $title = "Cadastro de Setores - HelpDesk";
    ...
    function getDescricao($idSetor) {
        ...
        return $linha[0]["descricao"];
    }

    if ($acao == "alterar") {
        $value = "editar";
        $idSetor = $_GET["idSetor"];
        $descricao = getDescricao($idSetor);
    } else {
        $value = "salvar";
        $descricao = "";
    }
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-body">
                                            <form method="post" action="action/actSetor.php">
                                                <div class="row">
                                                    <input type="hidden" id="idSetor" name="idSetor" value="<?php echo $idSetor;?>">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="descricao"><strong>Descrição</strong><br></label><input class="form-control" type="text" id="descricao" name="descricao" required="" minlength="2" value="<?php echo $descricao;?>"></div>
                                                    </div>
                                                    <div class="col">
