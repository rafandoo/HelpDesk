                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0"><span><?php echo countAguardandoAtendimentos($setor);?></span></div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0"><span><?php echo countEmAtendimento($setor);?></span></div>
                                            </div>
                                        ...
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="row g-0 align-items-center">
                                                    <div class="col-auto">
                                                        <div class="text-dark fw-bold h5 mb-0"><span><?php echo countPendentes($setor);?></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0"><span><?php echo countFinalizados($setor);?></span></div>
                                            </div>
