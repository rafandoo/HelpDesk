<?php
    ...
    if ($acao == 'salvarC') {
        ...
        updateCliente(buildCliente($_POST['idCliente'], $_POST['nome'], $_POST['nomeFantasia'], $_POST['cpfCnpj'], $_POST['endereco'], $_POST['numero'], $_POST['bairro'], $_POST['cidade'], $_POST['email'], $_POST['telefone'], $_POST['observacoes'], $_POST['idUsuario'], $_POST['situacao']));
