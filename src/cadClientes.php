                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="nome"><strong>Nome</strong></label><input class="form-control" type="text" id="nome" name="nome" required="" minlength="2"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="nomeFantasia"><strong>Nome Fantasia</strong><br></label><input class="form-control" type="text" id="nomeFantasia" name="nomeFantasia"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="cpfCnpj"><strong>CPF/CNPJ</strong><br></label><input class="form-control" type="text" id="cpfCnpj" placeholder="00.000.000/0001-00" name="cpfCnpj" required="" minlength="11"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="telefone"><strong>Telefone</strong><br></label><input class="form-control" type="text" id="telefone" placeholder="(47) 90000-0000" name="telefone"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="endereco"><strong>Endereço</strong><br></label><input class="form-control" type="text" id="endereco" placeholder="Nome da rua e número" name="endereco" required="" minlength="10"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="estado"><strong>Estado</strong><br></label><select class="form-select" id="estado" required="" name="estado">
                                                                <option value="">Selecione uma opção</option>
                                                            </select></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="cidade"><strong>Cidade</strong><br></label><select class="form-select" id="cidade" required="" name="cidade">
                                                                <option value="">Selecione uma opção</option>
                                                            </select></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="observacoes"><strong>Observações</strong><br></label><textarea class="form-control" id="observacoes" name="observacoes" rows="3"></textarea></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
